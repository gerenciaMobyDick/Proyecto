...
namespace Deporte2._2
{
    class Generar
    {
        ...
        public class Deportista /*Generar Deportista (IdDeportista, Nom, Apellido, Peso, Altura, AnosEntr)*/
        {
            ...
            public Deportista(int IdDeportista, string Nom, string Apellido, double Peso, double Altura, int AnosEntr)
            {
        ...
        public class RegEvento
        {
            public int RegNacional(Generar.Evento.Nacional Evento)
            {
                ...
                string sql = "INSERT INTO Nacional (IdEvento, NomEvento, Pais) VALUES(@IdEvento, @NomEvento, @Pais)";
                MySqlCommand comando = new MySqlCommand(sql, conexion);
